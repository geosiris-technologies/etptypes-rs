...
pub fn eunsupported_protocol() -> ErrorInfo {
    ErrorInfo {
        code: 4,
        message: r#"The endpoint does not support the protocol identified in a message header."#
            .to_string(),
    }
}
...
pub fn einvalid_indexkind() -> ErrorInfo {
    ErrorInfo {
        code: 20,
        message:
            r#"Sent by either role when an index kind used in a message is invalid for the data."#
                .to_string(),
    }
}
...
pub fn enosupportedformats() -> ErrorInfo {
    ErrorInfo {
        code: 21,
        message: r#"The server does not support any of the client's supported formats."#
            .to_string(),
    }
}
...
pub fn enosupporteddataobjecttypes() -> ErrorInfo {
    ErrorInfo {
        code: 29,
        message: r#"The server does not support any of the client's supported data object types."#
            .to_string(),
    }
}
...
pub fn einvalid_append() -> ErrorInfo {
    ErrorInfo {
        code: 31,
        message:
            r#"Sent in response to a ChannelData message that is not appending data to a channel."#
                .to_string(),
    }
}
