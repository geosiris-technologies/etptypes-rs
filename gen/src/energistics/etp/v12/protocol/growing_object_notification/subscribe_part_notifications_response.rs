...
fn subscribepartnotificationsresponse_avro_schema() -> Option<Schema> {
...
impl Schemable for SubscribePartNotificationsResponse {
    fn avro_schema(&self) -> Option<Schema> {
        subscribepartnotificationsresponse_avro_schema()
    }
...
impl AvroSerializable for SubscribePartNotificationsResponse {}

impl AvroDeserializable for SubscribePartNotificationsResponse {
    fn avro_deserialize<R: Read>(input: &mut R) -> AvroResult<SubscribePartNotificationsResponse> {
        let record = from_avro_datum(
            &subscribepartnotificationsresponse_avro_schema().unwrap(),
            input,
            None,
        )
        .unwrap();
