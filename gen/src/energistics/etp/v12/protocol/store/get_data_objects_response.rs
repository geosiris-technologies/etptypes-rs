...
fn getdataobjectsresponse_avro_schema() -> Option<Schema> {
...
impl Schemable for GetDataObjectsResponse {
    fn avro_schema(&self) -> Option<Schema> {
        getdataobjectsresponse_avro_schema()
    }
...
impl AvroSerializable for GetDataObjectsResponse {}

impl AvroDeserializable for GetDataObjectsResponse {
    fn avro_deserialize<R: Read>(input: &mut R) -> AvroResult<GetDataObjectsResponse> {
        let record =
            from_avro_datum(&getdataobjectsresponse_avro_schema().unwrap(), input, None).unwrap();
        from_value::<GetDataObjectsResponse>(&record)
    }
}

impl ETPMetadata for GetDataObjectsResponse {
...
impl GetDataObjectsResponse {
    pub fn as_protocol_message(&self) -> ProtocolMessage {
        ProtocolMessage::Store_GetDataObjectsResponse(self.clone())
    }
}
