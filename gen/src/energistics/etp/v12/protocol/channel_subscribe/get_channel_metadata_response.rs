...
pub struct GetChannelMetadataResponse {
    ...
    pub metadata: HashMap<String, ChannelMetadataRecord>,
}

fn getchannelmetadataresponse_avro_schema() -> Option<Schema> {
...
impl Schemable for GetChannelMetadataResponse {
    fn avro_schema(&self) -> Option<Schema> {
        getchannelmetadataresponse_avro_schema()
    }
...
impl AvroSerializable for GetChannelMetadataResponse {}

impl AvroDeserializable for GetChannelMetadataResponse {
    fn avro_deserialize<R: Read>(input: &mut R) -> AvroResult<GetChannelMetadataResponse> {
        let record = from_avro_datum(
            &getchannelmetadataresponse_avro_schema().unwrap(),
            input,
            None,
        )
        .unwrap();
        from_value::<GetChannelMetadataResponse>(&record)
    }
}

impl ETPMetadata for GetChannelMetadataResponse {
...
impl GetChannelMetadataResponse {
    pub fn as_protocol_message(&self) -> ProtocolMessage {
        ProtocolMessage::ChannelSubscribe_GetChannelMetadataResponse(self.clone())
    }
}
