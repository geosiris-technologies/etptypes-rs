...
fn getresourcesresponse_avro_schema() -> Option<Schema> {
...
impl Schemable for GetResourcesResponse {
    fn avro_schema(&self) -> Option<Schema> {
        getresourcesresponse_avro_schema()
    }
...
impl AvroSerializable for GetResourcesResponse {}

impl AvroDeserializable for GetResourcesResponse {
    fn avro_deserialize<R: Read>(input: &mut R) -> AvroResult<GetResourcesResponse> {
        let record =
            from_avro_datum(&getresourcesresponse_avro_schema().unwrap(), input, None).unwrap();
        from_value::<GetResourcesResponse>(&record)
    }
}
...
impl GetResourcesResponse {
    pub fn as_protocol_message(&self) -> ProtocolMessage {
        ProtocolMessage::Discovery_GetResourcesResponse(self.clone())
    }
}
