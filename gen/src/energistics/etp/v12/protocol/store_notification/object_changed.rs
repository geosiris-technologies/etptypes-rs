...
impl ObjectChanged{
    ...
    pub fn default_with_params(_change: ObjectChange, )
    -> ObjectChanged {
        ObjectChanged {
            change : _change,
