...
impl ReplaceRange {
    ...
    pub fn default_with_params(changed_interval: IndexInterval) -> ReplaceRange {
        ReplaceRange {
            changed_interval,
            channel_ids: vec![],
            data: vec![],
