     ...
     fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(
            ...
            match self {
                ...
                DataObjectCapabilityKind::max_contained_data_object_count => "MaxContainedDataObjectCount",
                DataObjectCapabilityKind::max_data_object_size => "MaxDataObjectSize",
                DataObjectCapabilityKind::orphaned_children_pruned_on_delete => "OrphanedChildrenPrunedOnDelete",
