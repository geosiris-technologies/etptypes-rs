...
fn putuninitializeddataarraytype_avro_schema() -> Option<Schema> {
...
impl Schemable for PutUninitializedDataArrayType {
    fn avro_schema(&self) -> Option<Schema> {
        putuninitializeddataarraytype_avro_schema()
    }
...
impl AvroSerializable for PutUninitializedDataArrayType {}

impl AvroDeserializable for PutUninitializedDataArrayType {
    fn avro_deserialize<R: Read>(input: &mut R) -> AvroResult<PutUninitializedDataArrayType> {
        let record = from_avro_datum(
            &putuninitializeddataarraytype_avro_schema().unwrap(),
            input,
            None,
        )
        .unwrap();
        from_value::<PutUninitializedDataArrayType>(&record)
    }
}
