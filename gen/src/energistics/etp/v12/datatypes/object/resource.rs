...
impl Resource{
    ...
    pub fn default_with_params(_source_count: Option<i32>, _target_count: Option<i32>, _last_changed: i64, _store_last_write: i64, _store_created: i64, _active_status: ActiveStatusKind, )
    -> Resource {
        Resource {
            uri : "".to_string(),
            alternate_uris : vec!(),
