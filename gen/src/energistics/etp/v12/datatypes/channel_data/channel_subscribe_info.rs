...
impl ChannelSubscribeInfo{
    ...
    pub fn default_with_params(_channel_id: i64, _start_index: IndexValue, _request_latest_index_count: Option<i32>, )
    -> ChannelSubscribeInfo {
        ChannelSubscribeInfo {
            channel_id : _channel_id,
            start_index : _start_index,
            data_changes : true,
            request_latest_index_count : _request_latest_index_count,
        }
    }
}
